# Lesson 04: Decentralized AI Agents
...
- Create a simple agent to experiment with the Coinbase AgentKit
- Make the agent answer about your project by configuring the agent context information
- Make a function for the agent to give the contact email address for your project (and/or any other CTA that you may want to include)
